  ...
  return (
    <div className="min-h-screen bg-gradient-primary relative overflow-hidden">
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12 relative z-10">
        ...
        >
          <motion.div
            className="inline-flex items-center justify-center w-40 h-40 mb-8 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl"
            animate={{ 
              rotate: [0, 3, -3, 0], 
              scale: [1, 1.02, 1],
              boxShadow: [
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex space-x-4">
                      <Button
                        ...
                        className="flex-1 py-4 px-6 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl text-white font-semibold shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:transform-none"
                      >
                        Join Session
                      </Button>
                      <Button
                        ...
                        variant="outline"
                        className="py-4 px-6 bg-white/20 backdrop-blur-xl border-white/20 text-white hover:bg-white/30 rounded-2xl"
                      >
                        <QrCode size={20} />
                      </Button>
                    </div>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex space-x-4">
                      <Button
                        ...
                        className="flex-1 py-4 px-6 bg-gradient-to-r from-amber-500 to-orange-600 rounded-2xl text-white font-semibold shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:transform-none"
                      >
